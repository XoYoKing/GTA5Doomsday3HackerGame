...
const CGFloat _lazer_particle_flying_speed = 1200; // points per second
...
+ (instancetype)lazerParticleWithZRotation:(CGFloat)zRotation position:(CGPoint)position {
    LazerParticle *par = [LazerParticle spriteNodeWithColor:[SKColor cyanColor] size:CGSizeMake(4, 4)];
